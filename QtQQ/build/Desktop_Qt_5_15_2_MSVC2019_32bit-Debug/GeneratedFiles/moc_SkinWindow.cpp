...
QT_MOC_LITERAL(2, 32, 0) // ""
    ...
    "SkinWindow\0onButtonCloseClicked\0"
};
...
void SkinWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SkinWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SkinWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<BasicWindow::staticMetaObject>(),
    qt_meta_stringdata_SkinWindow.data,
    qt_meta_data_SkinWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
